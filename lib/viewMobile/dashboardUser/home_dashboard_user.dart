...
class HomeDashboardUser extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return GetX<Userdahsboardcontroller>(
      builder: (_) => AnimatedSwitcher(
          ...
          child: Scaffold(
            body: _buildDashboard(context, controller, themeController,
                subController, userController, homeController),
          )),
    );
  }
    ...
    return Container(
      ...
      child: Stack(
        children: [
          CustomScrollView(
            slivers: [
              _buildAppBar(controller, themeController, homeController),
              SliverToBoxAdapter(
                  child:
                      _buildUserInfoSection(userController, themeController)),
              SliverToBoxAdapter(
  ...
  Widget _buildUserInfoSection(
      LoadingController controller, ThemeController themeController) {
    return Padding(
      padding: EdgeInsets.symmetric(horizontal: 20.w, vertical: 15.h),
      child: Column(
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  SizedBox(height: 10.h),
                  _buildSecurityStatus(controller, themeController),
                ],
              ),
            ),
          ),
  ...
  SliverAppBar _buildAppBar(Userdahsboardcontroller controller,
  ...
  Widget _buildSubscriptionSection(SubscriptionController controller,
    ...
    return Obx(() {
      ...
      if (controller.subscriptions.isEmpty) {
        return _buildNoSubscriptionCard(themeController);
      }
  ...
  Widget _buildNoSubscriptionCard(ThemeController themeController) {
    return Padding(
      padding: EdgeInsets.symmetric(horizontal: 20.w, vertical: 15.h),
      child: Container(
        width: double.infinity,
