...
class _AboutTermsPrivacyPageState extends State<AboutTermsPrivacyPage>
  ...
  Widget _buildTabBar() {
    return Container(
      ...
      child: TabBar(
        controller: _tabController,
        indicatorColor: AppColors.backgroundColorIconBack(
            Get.find<ThemeController>().isDarkMode.value),
        labelColor: AppColors.backgroundColorIconBack(
            Get.find<ThemeController>().isDarkMode.value),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildSectionBody("• يحق للمستخدم استخدام التطبيق بشكل قانوني ومناسب.\n"
