...
import 'create_info_data.dart';

class ChosePusher extends StatelessWidget {
  const ChosePusher({super.key});
  ...
  Widget _buildSetupButton({
    ...
    return Material(
      ...
      elevation: 5,
      child: InkWell(
        onTap: () => _handleSetupAction(loadingController, controller),
        borderRadius: BorderRadius.circular(12.r),
        child: Container(
          width: 220.w,
  ...
  void _handleSetupAction(
      LoadingController loadingController, Settingscontroller controller) {
