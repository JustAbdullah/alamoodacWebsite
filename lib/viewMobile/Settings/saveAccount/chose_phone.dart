...
import 'ques_save_account.dart';

class ChosePhone extends StatelessWidget {
  const ChosePhone({super.key});
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  _buildNextButton(settingsController, loadingController),
                ],
              ),
            ),
          ),
  ...
  Widget _buildNextButton(
      Settingscontroller controller, LoadingController loadingController) {
    return InkWell(
      onTap: () => _handleNextButton(controller, loadingController),
