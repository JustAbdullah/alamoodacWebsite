...
class ShowAskDeleteAccount extends StatelessWidget {
  const ShowAskDeleteAccount({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Obx(
      () => AnimatedSwitcher(
        ...
        child: settingsController.showAskToDeleteAccount.value
            ? _buildDestructiveDialog(
  ...
  void _performAccountDeletion(Settingscontroller controller) {
    controller.softDeleteUserMobile();
  }
}
