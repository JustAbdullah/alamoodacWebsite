      ...
      child: Column(
        children: [
          ...
          DropdownField(
            ...
            onChanged: (value) {
              controller.detailControllers["هل يوجد خدمة توصيل"]?.text = value!;
          ...
          DropdownField(
            ...
            selectedItem: "غير مدخل".tr,
            onChanged: (value) {
              controller.detailControllers["يوجد دفع الكتروني"]?.text = value!;
              print('تم اختيار: $value');
            },
          ),
          SizedBox(height: 20.h),
    ...
    return SingleChildScrollView(
      ...
      child: Column(
        children: [
          ...
          _buildReviewItem('المدينة', homeController.selectedCityName.value),
          _buildReviewItem('المنطقة', areaController.selectedAreaName.value),
