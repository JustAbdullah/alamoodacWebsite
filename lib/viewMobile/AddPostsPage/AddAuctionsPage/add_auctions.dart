...
class AddAuction extends StatefulWidget {
  ...
  const AddAuction({Key? key, required this.onConfirm}) : super(key: key);
              ...
              await pickDateTime(
                ...
                onDateTimePicked: (dateTime) {
                  setState(() {
                    ...
                    controller.startDateTime=dateTime;
                     print("UTC Start: ${dateTime.toUtc()}");
                  });
                },
              );
            },
                ...
                onDateTimePicked: (dateTime) {
                  setState(() {
                    endDateTime = dateTime;
                                        print("Date Of End ${endDateTime}");  
                                         print("UTC Start: ${dateTime.toUtc()}"); controller.endDateTime=dateTime;
