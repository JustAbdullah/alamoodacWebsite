...
class MostViewPosts extends StatefulWidget {
  const MostViewPosts({super.key});

  @override
  _MostViewPostsState createState() => _MostViewPostsState();
}
  ...
  Widget _buildContentSection() {
    return Expanded(
      child: Obx(() {
        ...
        if (controller.postsListMostView.isEmpty) {
          return _EmptyState(controller: controller);
        }
        return _postsListMostView(
          posts: controller.postsListMostView,
...
class _postsListMostView extends StatelessWidget {
  final List<Post> posts;
  final ThemeController themeController;

  const _postsListMostView({
    required this.posts,
