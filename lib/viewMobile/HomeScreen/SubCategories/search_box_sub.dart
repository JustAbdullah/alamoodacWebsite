...
class SearchBoxSub extends StatelessWidget {
  const SearchBoxSub({Key? key}) : super(key: key);
  ...
  Widget _getSearchComponent(int categoryId) {
    switch (categoryId) {
      ...
      case 9:
      case 16:
        return const AllTypePricesSub();
      default:
        return categoryId != 0 ? const AllTypePricesSub() : const SizedBox();
    }
  }
