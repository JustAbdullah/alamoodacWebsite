...
class RealestateTypeSubDeskTop extends StatelessWidget {
  const RealestateTypeSubDeskTop({super.key});
        ...
        print("لم يتم العثور على المنطقة: $value");
              ...
              TextField(
                ...
                controller: searchController
                    .detailRealestateControllers["السعر الأدنى"],
              ...
              TextField(
                ...
                controller: searchController
                    .detailRealestateControllers["السعر الأعلى"],
                keyboardType: TextInputType.number,
                decoration: InputDecoration(
                  labelStyle: TextStyle(
                    fontFamily: AppTextStyles.DinarOne,
