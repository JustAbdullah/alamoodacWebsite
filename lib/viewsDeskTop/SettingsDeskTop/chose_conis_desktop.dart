...
class ChoseConisDeskTopPage  extends StatelessWidget {
  ChoseConisDeskTopPage ({super.key});
        ...
        child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _buildCurrentCurrencyCard(homeController, themeController),
                    SizedBox(height: 30.h),
                    ...
                    Expanded(
                      child: ListView.separated(
                        ...
                        itemBuilder: (_, index) => _buildCurrencyCard(
                            currencies[index], homeController, themeController),
                      ),
                    ),
                  ],
                ),
  ...
  Widget _buildCurrentCurrencyCard(
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: AppColors.backgroundColorIconBack(Get.find<ThemeController>().isDarkMode.value).withOpacity(0.3)),
      ),
      child: Row(
        children: [
          Icon(Icons.info_outline_rounded,
              color: AppColors.backgroundColorIconBack(Get.find<ThemeController>().isDarkMode.value), size: 24.w),
          SizedBox(width: 15.w),
          Expanded(
            child: Text(
