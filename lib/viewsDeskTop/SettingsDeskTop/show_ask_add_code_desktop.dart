...
class ShowAskAddCodeDeskTopPage extends StatelessWidget {
  const ShowAskAddCodeDeskTopPage({super.key});

  @override
  Widget build(BuildContext context) {
    final themeController = Get.find<ThemeController>();
    final settingsTheController = Get.find<Settingscontroller>();

    return Obx(
      () => AnimatedSwitcher(
        duration: const Duration(milliseconds: 300),
        child:_buildFullScreenDialog(context, themeController,settingsTheController)
  ...
  Widget _buildFullScreenDialog(
      BuildContext context, ThemeController themeController, Settingscontroller settingsController ) {
      ...
      body: SafeArea(
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              _buildHeaderSection(isDarkMode,settingsController,themeController),
  ...
  Widget _buildHeaderSection(bool isDarkMode,Settingscontroller controller,ThemeController themeController) {
    return Row(
      children: [
        InkWell(
      onTap: () =>  Get.back(),
  ...
  Widget _buildProcessGuide(bool isDarkMode) {
    return Column(
      ...
      children: [
        ...
        _buildStepItem("1", "احصل على كود التفعيل من المصدر المعتمد".tr, isDarkMode),
        _buildStepItem("2", "أدخل الكود في الحقل المخصص أدناه".tr, isDarkMode),
        _buildStepItem("3", "اضغط على زر التفعيل لإكمال العملية".tr, isDarkMode),
      ],
    );
  }
  ...
  Widget _buildCodeInputSection(bool isDarkMode) {    SubscriptionController subscriptionController = Get.put(SubscriptionController());
    ...
    return Column(
      ...
      children: [
        ...
        Container(
          ...
          child: TextField(controller:subscriptionController.codeController,
            ...
            decoration: InputDecoration(
              ...
              hintStyle: TextStyle(  fontFamily: AppTextStyles.DinarOne,
  ...
  Widget _buildActivationButton(bool isDarkMode ,BuildContext context) {
    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        onPressed: () {
          subscriptionController.redeemSubscriptionCode(
