...
class PostSearchingListDeskTop extends StatelessWidget {
  const PostSearchingListDeskTop({super.key});
  ...
  Widget _buildPostsList() {
    return SingleChildScrollView(
        child: GetBuilder<Searchcontroller>(builder: (searchCtrl) {
      return Column(
        children: List.generate(
          searchCtrl.searchPostsList.length,
          (index) {
            final post = searchCtrl.searchPostsList[index];
                      ...
                      children: [
                        ...
                        ConstrainedBox(
                          constraints: BoxConstraints(
                            maxWidth: 320.w, // الحد الأقصى للعرض
                          ),
                          child: Text(
                            cityName,
