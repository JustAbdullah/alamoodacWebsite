...
class _UsersPostsDeskTopState extends State<UsersPostsDeskTop> {
  ...
  Widget _buildPostCard(
    ...
    final formattedDate = intl.DateFormat("dd MMM yyyy, hh:mm a", "ar")
        ...
        child: Column(
          ...
          children: [
            InkWell(
                ...
                splashColor: AppColors.backgroundColorIconBack(Get.find<ThemeController>().isDarkMode.value).withOpacity(0.1),
                highlightColor: AppColors.backgroundColorIconBack(Get.find<ThemeController>().isDarkMode.value).withOpacity(0.05),
                    ...
                    children: [
                      ...
                      ConstrainedBox(
                        constraints: BoxConstraints(
                          maxWidth: 120.w, // الحد الأقصى للعرض
                        ),
                        child: Text(
                          cityName,
                          overflow: TextOverflow
                              .ellipsis, // إذا كان النص طويلًا، يظهر بنقاط (...)
                      ...
                      ConstrainedBox(
                        constraints: BoxConstraints(
                          maxWidth: 150.w, // الحد الأقصى للعرض
                        ),
                        child: Text(
                          subCategoryName,
                          overflow: TextOverflow
    ...
    return Center(
      child: Column(
        ...
        children: [
          ...
          SizedBox(height: 10.h), // مسافة بين النصين
          // نص إضافي
          Text(
          ...
          SizedBox(height: 20.h), // مسافة قبل الزر
          // زر إنشاء منشور جديد
        ],
      ),
    );
