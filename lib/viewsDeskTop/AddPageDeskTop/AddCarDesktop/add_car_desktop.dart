...
class AddCarDesktop extends StatelessWidget {
  AddCarDesktop({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    final add = Get.put(AddpostCarController());
          ...
          child: Column(
            ...
            children: [
              ...
              DropdownField(
                ...
                selectedItem: "غير مدخل".tr,
                onChanged: (value) {
                  controller.detailControllers["نوع ناقل الحركة"]?.text =
                      value!;
                  print('تم اختيار: $value');
                },
              ),
              ...
              DropdownField(
                ...
                selectedItem: "غير مدخل".tr,
                onChanged: (value) {
                  controller.detailControllers["إمكانية الإيجار"]?.text =
                      value!;
                  print('تم اختيار: $value');
                },
              ),
