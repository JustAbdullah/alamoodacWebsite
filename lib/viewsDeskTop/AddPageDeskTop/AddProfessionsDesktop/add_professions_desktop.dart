...
class AddProfessionsDesktop extends StatelessWidget {
  AddProfessionsDesktop({super.key});
  ...
  Widget build(BuildContext context) {
    final addpostcontroller = Get.put(AddpostProfessionController());
    final homeController = Get.put(HomeController());
    final themeController = Get.put(ThemeController());
    final areaController = Get.put(AreaController());
    final userData = Get.put(Userdahsboardcontroller());

    return GetX<AddpostProfessionController>(
      builder: (controller) => Visibility(
        visible: controller.showAddProfession.value,
        child: Scaffold(
  ...
  Widget _buildStepProgress(AddpostProfessionController controller) {
    return Obx(
      () => Container(
        width: 600.w,
  ...
  Widget _buildStep1(
    ...
    AddpostProfessionController controller,
  ...
  Widget _buildPublisherDropdown(AddpostProfessionController controller,
      Userdahsboardcontroller userData) {
  ...
  Widget _buildCategoryDropdowns(AddpostProfessionController controller) {
    return SizedBox(
          width: 600.w,
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.center,
  ...
  Widget _buildStep3(BuildContext context,
      AddpostProfessionController controller, ThemeController themeController) {
    return SingleChildScrollView(
      physics: const BouncingScrollPhysics(),
      keyboardDismissBehavior: ScrollViewKeyboardDismissBehavior.onDrag,
      padding: EdgeInsets.all(16.w).copyWith(
      ...
      child: SizedBox(
        ...
        children: [
          ...
          PostDetailsField(
            maxLines: 2,
            label: "الاسم الكامل".tr,
            hint: "ادخل اسمك هنا".tr,
            controller: controller.detailControllers["الاسم الكامل"],
            keyboardType: TextInputType.text,
          ),
          SizedBox(height: 20.h),
          PostDetailsField(
            maxLines: 1,
            label: "العمر".tr,
            hint: "ادخل عمرك هنا".tr,
            controller: controller.detailControllers["العمر"],
          ...
          PostDetailsField(
            maxLines: 2,
            label: "اللغات".tr,
            hint: "ادخل اللغات التي تجيدها هنا".tr,
            controller: controller.detailControllers["اللغات"],
            keyboardType: TextInputType.text,
          ),
          SizedBox(height: 20.h),
          PostDetailsField(
            maxLines: 2,
            label: "ساعات النشاط".tr,
            hint: "ادخل الأوقات المفضلة او المتفرغ فيها للعمل هنا او نشاطك".tr,
            controller: controller.detailControllers["ساعات النشاط"],
            keyboardType: TextInputType.text,
          ),
          SizedBox(height: 20.h),
          PostDetailsField(
            maxLines: 3,
            label: "الخبرة".tr,
            hint: "أدخل هنا خبراتك بشكل نصي ومختصر".tr,
            controller: controller.detailControllers["الخبرة"],
            keyboardType: TextInputType.text,
          ),
          SizedBox(height: 20.h),
          PostDetailsField(
            ...
            hint: "أدخل هنا نبذة شخصية عنك بشكل كامل".tr,
  ...
  // أزرار التنقل
  Widget _buildNavigationButtons(AddpostProfessionController controller,
  ...
  // زر الإرسال النهائي
  Widget _buildSubmitButton(AddpostProfessionController controller,
  ...
  // إرسال الكائن كامل
                ...
                Get.find<AddpostProfessionController>().hideAll();
                Get.find<AddpostProfessionController>()
  ...
  void _validateAndProceed(AddpostProfessionController controller) {
    controller.currentStep.value++;
