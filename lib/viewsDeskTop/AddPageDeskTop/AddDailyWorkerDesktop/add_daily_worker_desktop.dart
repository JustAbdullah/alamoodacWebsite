...
class AddDailyWorkerDesktop extends StatelessWidget {
  AddDailyWorkerDesktop({super.key});
  ...
  Widget _buildStepProgress(Addpostdailyworkercontroller controller) {
   return Obx(
      () => Container(
        width: 600.w,
  ...
  Widget _buildStep1(
    ...
    Addpostdailyworkercontroller controller,
  ...
  Widget _buildPublisherDropdown(Addpostdailyworkercontroller controller,
      Userdahsboardcontroller userData) {
  ...
  Widget _buildCategoryDropdowns(Addpostdailyworkercontroller controller) {
    return SizedBox(
          width: 600.w,
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.center,
  ...
  // أزرار التنقل
  Widget _buildNavigationButtons(Addpostdailyworkercontroller controller,
  ...
  // زر الإرسال النهائي
  Widget _buildSubmitButton(Addpostdailyworkercontroller controller,
  ...
  void _validateAndProceed(Addpostdailyworkercontroller controller) {
    controller.currentStep.value++;
