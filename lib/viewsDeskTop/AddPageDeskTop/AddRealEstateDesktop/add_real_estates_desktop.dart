...
class AddRealEstatesDesktop extends StatelessWidget {
  AddRealEstatesDesktop({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return GetX<Addpostcontrollerrealestate>(
  ...
  Widget _buildStepProgress(Addpostcontrollerrealestate controller) {
    return Obx(
      () => Container(
        width: 600.w,
  ...
  Widget _buildStep1(
    ...
    Addpostcontrollerrealestate controller,
  ...
  Widget _buildPublisherDropdown(Addpostcontrollerrealestate controller,
      Userdahsboardcontroller userData) {
  ...
  Widget _buildCategoryDropdowns(Addpostcontrollerrealestate controller) {
    return SizedBox(
          width: 600.w,
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.center,
  ...
  Widget _buildStep3(BuildContext context,
      Addpostcontrollerrealestate controller, ThemeController themeController) {
    return SingleChildScrollView(
      physics: const BouncingScrollPhysics(),
      keyboardDismissBehavior: ScrollViewKeyboardDismissBehavior.onDrag,
      padding: EdgeInsets.all(16.w).copyWith(
      ...
      child: SizedBox(
        ...
        children: [
          ...
          PostDetailsField(
            maxLines: 2,
            label: "الحي-المنطقة".tr,
            hint: "أدخل الحي-المنطقة للبناء بشكل صحيح مثال: بغداد-شرق دجلة".tr,
            controller: controller.detailControllers["الحي-المنطقة"],
            keyboardType: TextInputType.text,
          ),
          SizedBox(
            height: 10.h,
          ...
          DropdownField(
            ...
            onChanged: (value) {
              controller.detailControllers["عدد الغرف"]?.text = value!;
              print('تم اختيار: $value');
            },
          ),
          SizedBox(height: 10.h),
          DropdownField(
            label: "عدد الحمامات".tr,
            items: [
              "غير مدخل".tr,
              "لايوجد",
              "واحد".tr,
            ...
            selectedItem: "غير مدخل".tr,
            onChanged: (value) {
              controller.detailControllers["عدد الحمامات"]?.text = value!;
              print('تم اختيار: $value');
            },
          ),
          ...
          DropdownField(
            ...
            selectedItem: "غير مدخل".tr,
            onChanged: (value) {
              controller.detailControllers["عدد الطوابق"]?.text = value!;
              print('تم اختيار: $value');
            },
          ),
          ...
          DropdownField(
            ...
            selectedItem: "غير مدخل".tr,
            onChanged: (value) {
              controller.detailControllers["مساحة البناء"]?.text = value!;
              print('تم اختيار مساحة البناء: $value');
            },
          ),

          SizedBox(height: 10.h),
          DropdownField(
            label: "مساحة الارض".tr,
            items: [
              "غير مدخل".tr,
              "أقل من 100 متر مربع".tr,
              "من 100 إلى 200 متر مربع".tr,
            ...
            selectedItem: "غير مدخل".tr,
            onChanged: (value) {
              controller.detailControllers["مساحة الارض"]?.text = value!;
              print('تم اختيار مساحة الأرض: $value');
            },
          ),
          ...
          DropdownField(
            ...
            selectedItem: "غير مدخل".tr,
            onChanged: (value) {
              controller.detailControllers["عمر البناء"]?.text = value!;
              print('تم اختيار: $value');
            },
          ),
          ...
          DropdownField(
            ...
            selectedItem: "غير مدخل".tr,
            onChanged: (value) {
              controller.detailControllers["طريقة الدفع"]?.text = value!;
              print('تم اختيار: $value');
            },
          ),
  ...
  // أزرار التنقل
  Widget _buildNavigationButtons(Addpostcontrollerrealestate controller,
  ...
  // زر الإرسال النهائي
  Widget _buildSubmitButton(Addpostcontrollerrealestate controller,
  ...
  void _validateAndProceed(Addpostcontrollerrealestate controller) {
    controller.currentStep.value++;
