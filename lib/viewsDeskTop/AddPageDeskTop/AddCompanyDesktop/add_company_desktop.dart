...
class AddCompanyDesktop extends StatelessWidget {
  AddCompanyDesktop({super.key});
  ...
  AppBar _buildAppBar(
      ThemeController themeController, Addpostcontrollercompany add) {
    return AppBar(
      leading: IconButton(
  ...
  Widget _buildStepProgress(Addpostcontrollercompany controller) {
    return Obx(
      () => Container(
        width: 600.w,
  ...
  Widget _buildStep1(
    ...
    Addpostcontrollercompany controller,
  ...
  Widget _buildPublisherDropdown(
      Addpostcontrollercompany controller, Userdahsboardcontroller userData) {
  ...
  Widget _buildCategoryDropdowns(Addpostcontrollercompany controller) {
    return SizedBox(
          width: 600.w,
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.center,
        ...
        Obx(() => Visibility(
              ...
              child: FormField<String>(
                validator: (value) => value == "غير مدخل"
                    ? 'يرجى اختيار القسم الفرعي الثاني'.tr
                    : null,
                builder: (FormFieldState<String> state) {
                  return SizedBox(
          width: 600.w,
      ...
      child: Form(
        child: SizedBox(
          ...
          children: [
            ...
            FormField<String>(
              validator: (value) =>
                  value == "غير مدخل".tr ? 'يرجى اختيار المدينة'.tr : null,
              builder: (FormFieldState<String> state) {
                return SizedBox(
          width: 600.w,
          child: Column(
            ...
            Obx(() {
              ...
              return FormField<String>(
                validator: (value) =>
                    value == "غير مدخل".tr ? 'يرجى اختيار المنطقة'.tr : null,
                builder: (FormFieldState<String> state) {
                  return SizedBox(
          width: 600.w,
          child: Column(
  ...
  Widget _buildStep3(BuildContext context, Addpostcontrollercompany controller,
      ThemeController themeController) {
    return SingleChildScrollView(
      physics: const BouncingScrollPhysics(),
      keyboardDismissBehavior: ScrollViewKeyboardDismissBehavior.onDrag,
      ...
      child: SizedBox(
        ...
        children: [
          ...
          PostDetailsField(
            maxLines: 3,
            label: "الوصف المختصر".tr,
            hint: "الوصف المختصر".tr,
            controller: controller.detailControllers["الوصف المختصر"],
            keyboardType: TextInputType.text,
          ),
          SizedBox(height: 20.h),
          PostDetailsField(
            maxLines: 3,
            label: "مواعيد العمل".tr,
            hint: "مواعيد العمل".tr,
            controller: controller.detailControllers["مواعيد العمل"],
            keyboardType: TextInputType.text,
          ),
          SizedBox(height: 20.h),
          DropdownField(
            label: "خدمة التوصيل".tr,
            items: [
              "غير مدخل".tr,
              "نعم".tr,
              "لا".tr,
            ...
            onChanged: (value) {
              controller.detailControllers["خدمة توصيل"]?.text = value!;
              print('تم اختيار: $value');
            },
          ),
          DropdownField(
            label: "خدمة الدفع الإلكتروني".tr,
            items: [
              "غير مدخل".tr,
              "نعم".tr,
              "لا".tr,
            ...
            selectedItem: "غير مدخل".tr,
            onChanged: (value) {
              controller.detailControllers["خدمة الدفع الإلكتروني"]?.text =
                  value!;
              print('تم اختيار: $value');
            },
          ),
          ...
          PostDetailsField(
            maxLines: 5,
            label: "الوصف الشامل".tr,
            hint: "الوصف الشامل".tr,
            controller: controller.detailControllers["الوصف الشامل"],
            keyboardType: TextInputType.text,
          ),
          SizedBox(height: 20.h),
          PostDetailsField(
  ...
  Widget _buildStep4(BuildContext context, Addpostcontrollercompany controller,
      ThemeController themeController) {
    return SingleChildScrollView(
      physics: const BouncingScrollPhysics(),
      keyboardDismissBehavior: ScrollViewKeyboardDismissBehavior.onDrag,
  ...
  Widget _buildImageItem(Addpostcontrollercompany controller, int index) {
    return Stack(
      children: [
       Image.memory(
  ...
  // أزرار التنقل
  Widget _buildNavigationButtons(Addpostcontrollercompany controller,
  ...
  // زر الإرسال النهائي
  Widget _buildSubmitButton(Addpostcontrollercompany controller,
  ...
  void _validateAndProceed(Addpostcontrollercompany controller) {
    controller.currentStep.value++;
