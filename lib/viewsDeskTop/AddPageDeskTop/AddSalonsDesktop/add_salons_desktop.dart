...
class AddSalonsDesktop extends StatelessWidget {
  AddSalonsDesktop({super.key});
  ...
  AppBar _buildAppBar(
      ThemeController themeController, Addpostsalonscontroller add) {
    return AppBar(
      leading: IconButton(
  ...
  Widget _buildStepProgress(Addpostsalonscontroller controller) {
    return Obx(
      () => Container(
        width: 600.w,
  ...
  Widget _buildStep1(
    ...
    Addpostsalonscontroller controller,
  ...
  Widget _buildPublisherDropdown(
      Addpostsalonscontroller controller, Userdahsboardcontroller userData) {
  ...
  Widget _buildCategoryDropdowns(Addpostsalonscontroller controller) {
    return SizedBox(
          width: 600.w,
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.center,
      children: [
        Obx(() => Visibility(
              ...
              child: FormField<String>(
                validator: (value) =>
                    value == "غير مدخل".tr ? 'يرجى اختيار القسم الفرعي' : null,
                builder: (FormFieldState<String> state) {
                  return SizedBox(
          width: 600.w,
          child: Column(
  ...
  Widget _buildStep3(BuildContext context, Addpostsalonscontroller controller,
      ThemeController themeController) {
    return SingleChildScrollView(
      physics: const BouncingScrollPhysics(),
      keyboardDismissBehavior: ScrollViewKeyboardDismissBehavior.onDrag,
      ...
      child: SizedBox(
        ...
        children: [
          ...
          DropdownField(
            ...
            onChanged: (value) {
              controller.detailControllers["قسم خاص للسيدات"]?.text = value!;
          ...
          PostDetailsField(
            maxLines: 5,
            label: "أنواع الاشتراكات".tr,
            hint: "أنواع الاشتراكات".tr,
            controller: controller.detailControllers["أنواع الاشتراكات"],
            keyboardType: TextInputType.text,
          ),
          SizedBox(height: 20.h),
          PostDetailsField(
          ...
          PostDetailsField(
            maxLines: 8,
            label: "المرافق والخدمات المتاحة".tr,
            hint: "المرافق والخدمات المتاحة".tr,
            controller:
                controller.detailControllers["المرافق والخدمات المتاحة"],
            keyboardType: TextInputType.text,
          ),
          SizedBox(height: 20.h),
          PostDetailsField(
            maxLines: 5,
            label: "الخدمات المميزة".tr,
            hint: "الخدمات المميزة".tr,
            controller: controller.detailControllers["الخدمات المميزة"],
            keyboardType: TextInputType.text,
          ),
          SizedBox(height: 20.h),
          PostDetailsField(
  ...
  Widget _buildStep4(BuildContext context, Addpostsalonscontroller controller,
      ThemeController themeController) {
    return SingleChildScrollView(
      physics: const BouncingScrollPhysics(),
      keyboardDismissBehavior: ScrollViewKeyboardDismissBehavior.onDrag,
  ...
  Widget _buildImageItem(Addpostsalonscontroller controller, int index) {
    return Stack(
      children: [
       Image.memory(
  ...
  // أزرار التنقل
  Widget _buildNavigationButtons(Addpostsalonscontroller controller,
  ...
  // زر الإرسال النهائي
  Widget _buildSubmitButton(Addpostsalonscontroller controller,
  ...
  void _validateAndProceed(Addpostsalonscontroller controller) {
    controller.currentStep.value++;
