...
class AddEducationalDesktop extends StatelessWidget {
  AddEducationalDesktop({super.key});
                  ...
                  Expanded(
                    child: PageView(
                      ...
                      children: [
                        ...
                        _buildStep3(context, controller, themeController),
  ...
  AppBar _buildAppBar(
      ThemeController themeController, Addpostcontrollereducational add) {
    return AppBar(
      leading: IconButton(
  ...
  Widget _buildStepProgress(Addpostcontrollereducational controller) {
   return Obx(
      () => Container(
        width: 600.w,
  ...
  Widget _buildStep1(
    ...
    Addpostcontrollereducational controller,
  ...
  Widget _buildPublisherDropdown(Addpostcontrollereducational controller,
      Userdahsboardcontroller userData) {
  ...
  Widget _buildCategoryDropdowns(Addpostcontrollereducational controller) {
    return SizedBox(
          width: 600.w,
          child: Column(
            crossAxisAlignment: CrossAxisAlignment.center,
      ...
      child: SizedBox(
        ...
        children: [
          ...
          PostDetailsField(
            ...
            label: "وصف مختصر".tr,
            hint: "وصف مختصر".tr,
            controller: controller.detailControllers["وصف مختصر"],
            keyboardType: TextInputType.text,
          ),
          SizedBox(height: 20.h),
          PostDetailsField(
            ...
            label: "وصف تفصيلي".tr,
            hint: "وصف تفصيلي".tr,
            controller: controller.detailControllers["وصف تفصيلي"],
            keyboardType: TextInputType.text,
          ),
          SizedBox(height: 20.h),
          DropdownField(
            label: "الفئات العمرية المستهدفة".tr,
            items: [
              "غير مدخل".tr,
              "غير مقيد".tr,
              "الأطفال (0-5 سنوات)".tr,
              "المرحلة الابتدائية (6-12 سنة)".tr,
              "المرحلة الإعدادية (13-15 سنة)".tr,
              "المرحلة الثانوية (16-18 سنة)".tr,
              "الجامعات والتعليم العالي (18+ سنة)".tr,
              "الدورات التعليمية والثقافية (مختلف الأعمار)".tr,
            ],
            selectedItem: "غير مدخل".tr,
            onChanged: (value) {
              controller.detailControllers["الفئات العمرية المستهدفة"]?.text =
                  value!;
          ...
          PostDetailsField(
            maxLines: 5,
            label: "البرامج التعليمية".tr,
            hint: "البرامج التعليمية".tr,
            controller: controller.detailControllers["البرامج التعليمية"],
            keyboardType: TextInputType.text,
          ),
          SizedBox(height: 20.h),
          PostDetailsField(
            maxLines: 5,
            label: "الأنشطة والخدمات الاضافية".tr,
            hint: "الأنشطة والخدمات الاضافية".tr,
            controller:
                controller.detailControllers["الأنشطة والخدمات الاضافية"],
            keyboardType: TextInputType.text,
          ),
          SizedBox(height: 20.h),
          PostDetailsField(
            maxLines: 5,
            label: "قائمة الأسعار والرسوم".tr,
            hint: "قائمة الأسعار والرسوم".tr,
            controller: controller.detailControllers["قائمة الأسعار والرسوم"],
            keyboardType: TextInputType.text,
          ),
          SizedBox(height: 20.h),
          DropdownField(
            label: "يوجد نظام تعليم عن بعد".tr,
            items: [
              "غير مدخل".tr,
              "نعم".tr,
              "لا".tr,
            ...
            selectedItem: "غير مدخل".tr,
            onChanged: (value) {
              controller.detailControllers["يوجد نظام تعليم عن بعد"]?.text =
                  value!;
              print('تم اختيار: $value');
            },
          ),
          SizedBox(height: 20.h),
          DropdownField(
            label: "يوجد شهادات تخصص بعد الإنتهاء".tr,
            items: ["غير مدخل".tr, "نعم".tr, "لا".tr, "المراحل التعليمية".tr],
            selectedItem: "غير مدخل".tr,
            onChanged: (value) {
              controller.detailControllers["يوجد شهادات تخصص بعد الإنتهاء"]
                  ?.text = value!;
              print('تم اختيار: $value');
            },
          ),
          SizedBox(height: 20.h),
          DropdownField(
            label: "يوجد محتوى تعليمي إلكتروني يمكن تحميله".tr,
            items: [
              "غير مدخل".tr,
              "نعم".tr,
              "لا".tr,
            ...
            onChanged: (value) {
              controller
                  .detailControllers["يوجد محتوى تعليمي إلكتروني يمكن تحميله"]
                  ?.text = value!;
              print('تم اختيار: $value');
            },
          ),
  ...
  Widget _buildImageItem(Addpostcontrollereducational controller, int index) {
    return Stack(
      children: [
       Image.memory(
  ...
  // أزرار التنقل
  Widget _buildNavigationButtons(Addpostcontrollereducational controller,
  ...
  // زر الإرسال النهائي
  Widget _buildSubmitButton(Addpostcontrollereducational controller,
  ...
  void _validateAndProceed(Addpostcontrollereducational controller) {
    controller.currentStep.value++;
