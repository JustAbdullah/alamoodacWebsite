          ...
          child: Column(
            ...
            children: [
              ...
              DropdownField(
                ...
                onChanged: (value) {
                  controller.detailControllers["الفئات العمرية المستهدفة"]
                      ?.text = value!;
              ...
              PostDetailsField(
                ...
                controller:
                    controller.detailControllers["قائمة الأسعار والرسوم"],
                keyboardType: TextInputType.text,
              ),
              SizedBox(height: 20.h),
              DropdownField(
              ...
              DropdownField(
                ...
                onChanged: (value) {
                  controller
                      .detailControllers[
                          "يوجد محتوى تعليمي إلكتروني يمكن تحميله"]
                      ?.text = value!;
                  print('تم اختيار: $value');
                },
              ),
