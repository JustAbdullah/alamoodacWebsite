...
class AuctionDetailsScreenDeskTop extends StatefulWidget {
  @override
  _AuctionDetailsScreenDeskTopState createState() => _AuctionDetailsScreenDeskTopState();
}

class _AuctionDetailsScreenDeskTopState extends State<AuctionDetailsScreenDeskTop> {
