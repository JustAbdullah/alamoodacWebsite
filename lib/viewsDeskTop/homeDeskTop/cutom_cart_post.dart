...
class CustomCardPostDeskTop extends StatefulWidget {
  ...
  @override
  State<CustomCardPostDeskTop> createState() => _CustomCardPostDeskTopState();
}
...
class _CustomCardPostDeskTopState extends State<CustomCardPostDeskTop> {
  ...
  Widget _buildContentSection() {
    return Obx(() {
      if (widget.isLoading.value) return _buildWebShimmerLoader();
      if (widget.postsList.isEmpty) return _buildWebEmptyState();
      return _buildWebpostsLists();
    });
  }
