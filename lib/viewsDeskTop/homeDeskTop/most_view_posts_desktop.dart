...
class MostViewPostsDesktop extends StatefulWidget {
  const MostViewPostsDesktop({super.key});

  @override
  _MostViewPostsDesktopState createState() => _MostViewPostsDesktopState();
}

class _MostViewPostsDesktopState extends State<MostViewPostsDesktop> {
  ...
  Widget _buildContentSection() {
    return Obx(() {
      if (controller.LoadingPostsMostView.value)
        return _buildWebShimmerLoader();
      if (controller.postsListMostView.isEmpty) return _buildWebEmptyState();
      return _buildWebPostsList();
    });
  }
  ...
  Widget _buildWebPostsList() {
    return ScrollConfiguration(
      ...
      child: ListView.builder(
        ...
        itemCount: controller.postsListMostView.length,
        itemBuilder: (context, index) {
          final post = controller.postsListMostView[index];
