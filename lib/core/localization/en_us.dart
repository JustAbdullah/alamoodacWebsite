...
"املأ جميع الحقول بشكل صحيح": "Fill all fields correctly",  
  ////////////////////////
    ...
    "تاريخ انتهاء العرض:": "Offer Expiration Date:",
    "بعد هذا التاريخ سيتم إخفاء المنشور تلقائيًا": "After this date, the post will be automatically hidden.",
    "مدة العرض:": "Display Duration:",
    "لا يوجد تاريخ انتهاء - العرض دائم": "No end date – permanent listing",
    "المنشور مخفي حالياً": "The post is currently hidden.",
    "انتهت فترة عرض هذا المنشور ولم يعد مرئياً للجمهور. يمكنك تجديد فترة العرض لاستمرار الظهور في النتائج.": "The display period for this post has ended and it is no longer visible to the public. You can renew the display period to continue appearing in search results.",
    "تجديد فترة العرض": "Renew Display Period",
    "قيد المراجعة": "Under Review",
    "المنشور قيد المراجعة من قبل الإدارة وسيظهر بعد الموافقة": "The post is under review by the administration and will appear once approved.",
    "منشور": "Post",
    "المنشور ظاهر للجمهور": "The post is visible to the public.",
    "مخفي": "Hidden",
    "انتهت فترة العرض ولم يعد المنشور مرئيًا": "The display period has ended and the post is no longer visible.",
    "حالة غير معروفة": "Unknown status",      "يمكنك اختيار الدولة التي تريد عرض محتواها": "You can choose the country whose content you want to display.",
  "موقع العرض": "Display Location",
  
  "عقارات للايجار": "Properties for Rent",
    "عقارات للبيع": "Properties for Sale",
    "الحي الصناعي": "Industrial District",
    "مكاتب ومؤسسات": "Offices and Institutions",
    "الخدمات الطبية": "Medical Services",
    "الخدمات المالية": "Financial Services",
    "الخدمات المتنوعة": "Miscellaneous Services",
