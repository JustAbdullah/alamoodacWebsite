...
class AddpostProfessionController extends GetxController {
  final List<String> targetLanguages = ["ar", "en", "tr", "ku"];

  RxBool showAddProfession = false.obs;
...
// 4. تعديل دالة رفع الصور
  ...
  final Map<String, TextEditingController> detailControllers = {
    "الاسم الكامل": TextEditingController(),
    "العمر": TextEditingController(),
    "اللغات": TextEditingController(),
    "ساعات النشاط": TextEditingController(),
    "الخبرة": TextEditingController(),
...
String? expiresAt =  Get.find<LoadingController>().currentUser?.free_post_used == 0
  ...
  void resetAll() {
    ...
    showAddProfession.value = false; // إخفاء الواجهة
