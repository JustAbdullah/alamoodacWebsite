...
class Addpostsalonscontroller extends GetxController {
...
Future<void> uploadImagesToServer() async {
  ...
  final Map<String, TextEditingController> detailControllers = {
    ...
    "المرافق والخدمات المتاحة": TextEditingController(), // نعم أو لا
    "أنواع الاشتراكات": TextEditingController(), // نعم أو لا
    "قسم خاص للسيدات": TextEditingController(), // نعم أو لا
    "الخدمات المميزة":
        TextEditingController(), // مثل (واي فاي، موقف سيارات، منطقة ألعاب للأطفال…)
