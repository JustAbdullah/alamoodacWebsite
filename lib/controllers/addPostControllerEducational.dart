...
class Addpostcontrollereducational extends GetxController {
  RxBool showAdd = false.obs;
  AreaController areaController = Get.put(AreaController());
final List<String> targetLanguages = ["ar", "en", "ckb"]; // تم تحديث الرمز الكردي إلى السورانية
...
Future<void> uploadImagesToServer() async {
  ...
  final Map<String, TextEditingController> detailControllers = {
    "وصف مختصر": TextEditingController(),
    "وصف تفصيلي":
        TextEditingController(), // يفضل أن تكون "نعم/لا" كخيار بدلاً من إدخال نصي
    "أوقات العمل": TextEditingController(),
    "الفئات العمرية المستهدفة": TextEditingController(), // نعم أو لا
    "البرامج التعليمية": TextEditingController(), // نعم أو لا
    "الأنشطة والخدمات الاضافية": TextEditingController(), // نعم أو لا
    "قائمة الأسعار والرسوم": TextEditingController(),
    "يوجد نظام تعليم عن بعد": TextEditingController(),
    "يوجد شهادات تخصص بعد الإنتهاء": TextEditingController(),
    "يوجد محتوى تعليمي إلكتروني يمكن تحميله": TextEditingController(),
    // مثل (واي فاي، موقف سيارات، منطقة ألعاب للأطفال…)
    "تفاصيل اضافية": TextEditingController(), // مثل
  };
