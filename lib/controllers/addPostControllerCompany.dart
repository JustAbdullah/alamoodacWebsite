...
class Addpostcontrollercompany extends GetxController {
...
Future<void> uploadImagesToServer() async {
  ...
  final Map<String, TextEditingController> detailControllers = {
    "الوصف المختصر": TextEditingController(),
    "الوصف الشامل": TextEditingController(),
    "مواعيد العمل": TextEditingController(), // بدل "أيام العمل" و "ساعات العمل"
    "خدمة التوصيل": TextEditingController(), // نعم/لا
    "خدمة الدفع الإلكتروني": TextEditingController(), // نعم/لا
    "الخدمات الإضافية":
        TextEditingController(), // مواقف، إنترنت مجاني، دعم فني 24/7...
