...
class Addpostrestaurantcontroller extends GetxController {
...
// 4. تعديل دالة رفع الصور
  ...
  final Map<String, TextEditingController> detailControllers = {
    "نبذة عن المطعم": TextEditingController(),
    ...
    "يوجد دفع الكتروني": TextEditingController(), // نعم أو لا
    "قسم العائلات": TextEditingController(), // نعم أو لا
    "أماكن الجلوس": TextEditingController(), // داخلي، خارجي، VIP...
    "الخدمات الإضافية":
